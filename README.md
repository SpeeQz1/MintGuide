...
Instructions on how to set it up are included bellow and further documentation on how the whole infrastructure works can be found in [docs currently are not implemented]().
...
1. Install [Docker Engine](<[t](https://docs.docker.com/engine/install/)>) from Docker's website.
